...
export const tier2Tests: Test[] = [
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        const res = await httpGet('/?lite=true');
        ...
        return { id: 'T2-R1-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R1-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        const res = await httpGet('/lab/non-existent-subpath-vault');
        ...
        return { id: 'T2-R2-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        const res = await httpGet(longPath);
        ...
        return { id: 'T2-R2-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R3-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        const res = await httpGet('/veille');
        ...
        return { id: 'T2-R3-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R4-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R4-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        if (match) {
          const cssRes = await httpGet(match[1]);
        ...
        return { id: 'T2-R5-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R5-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R6-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R6-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  ...
  },
  {
    ...
    type: 'static',
    run: async (): Promise<TestResult> => {
      const content = await readSourceFile('src/components/CyberCityBackground.tsx');
  ...
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R7-4', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
  {
    ...
    run: async (): Promise<TestResult> => {
      try {
        ...
        return { id: 'T2-R7-5', passed: false, message: 'Runtime check failed', details: (err as Error).message };
      }
    },
  },
];
