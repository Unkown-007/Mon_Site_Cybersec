...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/leaderboard", label: "Leaderboard", code: "LDR", desc: "Classement des opérateurs" },
  { href: "/team", label: "Équipe", code: "TEAM", desc: "Escouade CTF & unlocks partagés" },
  { href: "/profile", label: "Profil", code: "PRF", desc: "Identité, photo, unlocks, amis" },
