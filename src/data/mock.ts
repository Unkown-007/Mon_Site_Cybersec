...
export const RESOURCES: Resource[] = [
  ...
  // ── Lot étendu ──
  {
    id: "internalallthethings",
    title: "InternalAllTheThings",
    url: "https://github.com/swisskyrepo/InternalAllTheThings",
    domain: "Réseau",
    type: "cheatsheet",
    date: "2026-06-16",
    tags: ["active-directory", "pivoting", "méthodo"],
    desc: "Notes et payloads pour le pentest interne & Active Directory (par l'auteur de PayloadsAllTheThings).",
  },
  {
    id: "highoncoffee",
    title: "HighOn.Coffee Cheat Sheets",
    url: "https://highon.coffee/blog/penetration-testing-tools-cheat-sheet/",
    domain: "Réseau",
    type: "cheatsheet",
    date: "2026-06-16",
    tags: ["cheatsheet", "commandes"],
    desc: "Fiches de commandes pentest très pratiques (recon, réseau, privesc).",
  },
  {
    id: "exploit-db",
    title: "Exploit-DB",
    ...
    date: "2026-06-16",
    tags: ["exploits", "poc"],
    desc: "Base d'exploits publics et de PoC (interrogeable hors-ligne via searchsploit).",
  },
  {
    id: "opencve",
    title: "OpenCVE",
    ...
    date: "2026-06-16",
    tags: ["cve", "veille"],
    desc: "Suivi et alertes CVE par vendor/produit, avec recherche avancée.",
  },
  {
    id: "vulhub",
    title: "Vulhub",
    ...
    type: "lien",
    date: "2026-06-16",
    tags: ["docker", "vulnérable", "cve"],
    desc: "Environnements Docker pré-vulnérables pour reproduire des CVE en labo.",
  },
  {
    id: "juice-shop",
    ...
    date: "2026-06-16",
    tags: ["owasp", "labo", "web"],
    desc: "Application web volontairement vulnérable, moderne et complète pour s'entraîner.",
  },
  {
    id: "dvwa",
    title: "DVWA",
    ...
    type: "lien",
    date: "2026-06-16",
    tags: ["labo", "web", "débutant"],
    desc: "Damn Vulnerable Web App : classique pour pratiquer les failles web de base.",
  },
  {
    id: "loldrivers",
    title: "LOLDrivers",
    ...
    type: "outil",
    date: "2026-06-16",
    tags: ["windows", "drivers", "evasion"],
    desc: "Base des pilotes Windows vulnérables/malveillants (BYOVD).",
  },
  {
    id: "malapi",
    title: "MalAPI.io",
    ...
    type: "lien",
    date: "2026-06-16",
    tags: ["winapi", "malware", "reverse"],
    desc: "Référence des fonctions Windows API couramment utilisées par les malwares.",
  },
  {
    id: "vx-underground",
    ...
    type: "lien",
    date: "2026-06-16",
    tags: ["malware", "recherche", "samples"],
    desc: "Plus grande collection publique de code source et papiers sur les malwares.",
  },
  {
    id: "malwarebazaar",
    ...
    desc: "Partage d'échantillons de malwares pour l'analyse et la détection.",
  },
  {
    id: "any-run",
    title: "ANY.RUN",
    ...
    type: "outil",
    date: "2026-06-16",
    tags: ["sandbox", "analyse", "dynamique"],
    desc: "Sandbox d'analyse de malware interactive en ligne.",
  },
  {
    id: "virustotal",
    title: "VirusTotal",
    ...
    type: "outil",
    date: "2026-06-16",
    tags: ["scan", "ioc", "réputation"],
    desc: "Analyse multi-moteurs de fichiers/URLs et pivot sur des IOC.",
  },
  {
    id: "urlscan",
    title: "urlscan.io",
    ...
    type: "outil",
    date: "2026-06-16",
    tags: ["url", "phishing", "scan"],
    desc: "Analyse et capture d'une URL (ressources, redirections, captures).",
  },
  {
    id: "greynoise",
    title: "GreyNoise",
    ...
    type: "outil",
    date: "2026-06-16",
    tags: ["ip", "threat-intel", "bruit"],
    desc: "Distingue le bruit de fond Internet des scans/attaques ciblés par IP.",
  },
  {
    id: "ippsec",
    title: "IppSec.rocks",
    ...
    type: "lien",
    date: "2026-06-16",
    tags: ["htb", "vidéos", "writeups"],
    desc: "Moteur de recherche dans les vidéos de write-ups HackTheBox d'IppSec.",
  },
  {
    id: "0xdf",
    title: "0xdf — write-ups",
...
export const EXTERNAL_TOOLS: ExternalTool[] = [
  ...
  // ── Recon (lot étendu) ──
  { name: "feroxbuster", url: "https://github.com/epi052/feroxbuster", phase: "Recon", desc: "Brute-force de contenu web récursif, rapide, écrit en Rust.", cmd: "feroxbuster -u http://t -w list.txt", tags: ["fuzzing", "rust"] },
  { name: "dirsearch", url: "https://github.com/maurosoria/dirsearch", phase: "Recon", desc: "Brute-force de chemins web avec extensions et filtres de statut.", cmd: "dirsearch -u http://t -x 404", tags: ["dir", "web"] },
  { name: "gau", url: "https://github.com/lc/gau", phase: "Recon", desc: "Récupère les URLs connues d'un domaine (Wayback, OTX, Common Crawl).", cmd: "gau target.com", tags: ["urls", "osint"] },
  { name: "waybackurls", url: "https://github.com/tomnomnom/waybackurls", phase: "Recon", desc: "Liste les URLs archivées d'un domaine via la Wayback Machine.", cmd: "waybackurls target.com", tags: ["urls", "wayback"] },
  { name: "dnsx", url: "https://github.com/projectdiscovery/dnsx", phase: "Recon", desc: "Boîte à outils DNS rapide (résolution, bruteforce, enregistrements).", cmd: "dnsx -l hosts.txt -resp", tags: ["dns", "probe"] },
  { name: "WhatWeb", url: "https://github.com/urbanadventurer/WhatWeb", phase: "Recon", desc: "Identifie les technologies d'un site (CMS, frameworks, serveurs).", cmd: "whatweb https://t", tags: ["fingerprint", "web"] },
  { name: "wafw00f", url: "https://github.com/EnableSecurity/wafw00f", phase: "Recon", desc: "Détecte et identifie le pare-feu applicatif (WAF) d'un site.", cmd: "wafw00f https://t", tags: ["waf", "web"] },
  { name: "testssl.sh", url: "https://github.com/drwetter/testssl.sh", phase: "Recon", desc: "Audit complet de la configuration TLS/SSL d'un service.", cmd: "testssl.sh https://t:443", tags: ["tls", "audit"] },
  { name: "Sublist3r", url: "https://github.com/aboul3la/Sublist3r", phase: "Recon", desc: "Énumération de sous-domaines via moteurs de recherche.", cmd: "sublist3r -d target.com", tags: ["subdomains"] },
  { name: "Aquatone", url: "https://github.com/michenriksen/aquatone", phase: "Recon", desc: "Capture d'écran en masse de surfaces web pour triage visuel.", cmd: "cat hosts.txt | aquatone", tags: ["screenshots", "web"] },
  { name: "dnsenum", url: "https://github.com/fwaeytens/dnsenum", phase: "Recon", desc: "Énumération DNS (transferts de zone, bruteforce, sous-réseaux).", cmd: "dnsenum target.com", tags: ["dns", "enum"] },

  // ── Enum (lot étendu) ──
  { name: "onesixtyone", url: "https://github.com/trailofbits/onesixtyone", phase: "Enum", desc: "Scanner SNMP rapide pour deviner les community strings.", cmd: "onesixtyone -c community.txt 10.10.10.10", tags: ["snmp", "udp"] },
  { name: "nbtscan", url: "https://github.com/resurrecting-open-source-projects/nbtscan", phase: "Enum", desc: "Scan NetBIOS d'un sous-réseau (noms, partages, MAC).", cmd: "nbtscan 10.10.10.0/24", tags: ["netbios", "windows"] },
  { name: "windapsearch", url: "https://github.com/ropnop/windapsearch", phase: "Enum", desc: "Requêtes LDAP rapides sur un AD (utilisateurs, groupes, admins).", cmd: "windapsearch -d dom -u u -p p --da", tags: ["ldap", "ad"] },
  { name: "ldeep", url: "https://github.com/franc-pentest/ldeep", phase: "Enum", desc: "Énumération LDAP en profondeur d'un domaine Active Directory.", cmd: "ldeep ldap -u u -p p -d dom -s ldap://dc all", tags: ["ldap", "ad"] },
  { name: "adPEAS", url: "https://github.com/61106960/adPEAS", phase: "Enum", desc: "Énumération AD automatisée (PowerShell) façon PEAS.", cmd: "Invoke-adPEAS", tags: ["ad", "recon"] },

  // ── Exploit (lot étendu) ──
  { name: "searchsploit", url: "https://github.com/offensive-security/exploitdb", phase: "Exploit", desc: "Recherche hors-ligne dans la base Exploit-DB.", cmd: "searchsploit apache 2.4.49", tags: ["exploitdb"] },
  { name: "XSStrike", url: "https://github.com/s0md3v/XSStrike", phase: "Exploit", desc: "Détection et exploitation XSS avancée (fuzzing contextuel).", cmd: "xsstrike -u 'http://t/?q=1'", tags: ["xss", "web"] },
  { name: "tplmap", url: "https://github.com/epinna/tplmap", phase: "Exploit", desc: "Détection et exploitation d'injections de templates (SSTI).", cmd: "tplmap -u 'http://t/?n=1'", tags: ["ssti", "web"] },
  { name: "NoSQLMap", url: "https://github.com/codingo/NoSQLMap", phase: "Exploit", desc: "Audit et exploitation d'injections NoSQL (MongoDB & co).", cmd: "nosqlmap", tags: ["nosqli", "web"] },
  { name: "Ghauri", url: "https://github.com/r0oth3x49/ghauri", phase: "Exploit", desc: "Détection/exploitation d'injections SQL, alternative rapide à sqlmap.", cmd: "ghauri -u 'http://t/?id=1' --batch", tags: ["sqli", "web"] },
  { name: "ysoserial", url: "https://github.com/frohoff/ysoserial", phase: "Exploit", desc: "Génère des payloads de désérialisation Java exploitables.", cmd: "java -jar ysoserial.jar CC1 'id'", tags: ["deserialization", "java"] },

  // ── Post-exploit (lot étendu) ──
  { name: "proxychains-ng", url: "https://github.com/rofl0r/proxychains-ng", phase: "Post-exploit", desc: "Force n'importe quel outil à passer par un proxy/SOCKS (pivot).", cmd: "proxychains4 nmap -sT 10.0.0.0/24", tags: ["pivot", "proxy"] },
  { name: "gost", url: "https://github.com/ginuerzh/gost", phase: "Post-exploit", desc: "Tunnel/relais réseau polyvalent (SOCKS, port-forward, chaînage).", cmd: "gost -L socks5://:1080", tags: ["tunnel", "proxy"] },
  { name: "pwncat-cs", url: "https://github.com/calebstewart/pwncat", phase: "Post-exploit", desc: "Listener et post-exploitation : stabilise et automatise les shells.", cmd: "pwncat-cs -lp 4444", tags: ["shell", "post"] },
  { name: "SharpDPAPI", url: "https://github.com/GhostPack/SharpDPAPI", phase: "Post-exploit", desc: "Déchiffrement des secrets protégés par DPAPI sous Windows.", cmd: "SharpDPAPI.exe triage", tags: ["dpapi", "windows"] },
