...
const BASE =
  "relative overflow-hidden inline-flex items-center justify-center gap-2 rounded-sm border font-mono uppercase " +
...
const VARIANTS: Record<Variant, string> = {
  ...
  danger:
    "focus-ring-danger border-danger/70 bg-gradient-to-br from-danger/20 to-danger/5 text-danger hover:from-danger/30 hover:to-danger/10 hover:shadow-[0_0_15px_rgba(255,61,96,0.4)]",
};
